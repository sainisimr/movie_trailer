...
AVATAR = media.Movie(media.Movie.MOVIE_TITLE[1],\
         media.Movie.POSTER_IMAGE[1], media.Movie.TRAILER_YOUTUBE[1])
WALLE = media.Movie(media.Movie.MOVIE_TITLE[2],\
        media.Movie.POSTER_IMAGE[2], media.Movie.TRAILER_YOUTUBE[2])
BAB = media.Movie(media.Movie.MOVIE_TITLE[3],\
      media.Movie.POSTER_IMAGE[3], media.Movie.TRAILER_YOUTUBE[3])
FROZEN = media.Movie(media.Movie.MOVIE_TITLE[4],\
         media.Movie.POSTER_IMAGE[4], media.Movie.TRAILER_YOUTUBE[4])
